...
},{"./emojis":"node_modules/emojilib/emojis.json","./ordered":"node_modules/emojilib/ordered.json"}],"package.json":[function(require,module,exports) {
module.exports = {
  "name": "mojibar-web",
  "version": "1.0.0",
  ...
  "scripts": {
    ...
    "deploy": "gh-pages --repo git@github.com:paulirish/mojibar-web.git"
  },
  "author": "muan",
  "license": "MIT",
  "devDependencies": {
...
var preference; // var ipc = require('electron').ipcRenderer
...
var applyPreferences = function applyPreferences(preference, initialization) {
  localStorage.setItem('preference', JSON.stringify(preference)); // ipc.send('update-preference', preference, initialization)
  ...
  document.body.appendChild(style); // Update skin tone setting

  window.search(searchInput.value);
  searchInput.focus();
};

var savePreference = function savePreference(event) {
...
applyPreferences(preference, true); // ipc.on('open-preference', function (event, message) {
...
var togglePreferencePanel = function togglePreferencePanel() {
  if (document.body.classList.contains('on-preference')) {
    ...
    Object.keys(preferenceNames).forEach(function (key) {
      ...
      if (typeof preference[key] === 'boolean') {
        ...
        modifiers.forEach(function (modifier) {
          html += "<option value=\"".concat(modifier, "\" ").concat(preference[key] === modifier ? 'selected' : '', ">").concat(modifier, "</option>");
        });
        html += '</select>';
        html += '</label>';
      } else {
    ...
    html += "<code class=\"version\">mojibar@".concat(require('./package.json').version, "</code>");
    if (localStorage.getItem('emojilibVersion')) html += "<code class=\"version\">emojilib@".concat(localStorage.getItem('emojilibVersion'), "</code>");
    html += '</form>';
...
globalThis.togglePreferencePanel = togglePreferencePanel;
},{"emojilib":"node_modules/emojilib/index.js","./package.json":"package.json"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","settings.js"], null)
